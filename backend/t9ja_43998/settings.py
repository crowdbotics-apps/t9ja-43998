"""
Django settings for t9ja_43998 project.
...
WSGI_APPLICATION = 't9ja_43998.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "t9ja_43998 API",
    "DESCRIPTION": "API documentation for t9ja_43998 App",
    "VERSION": "v1",
}
